...
\end{tightemize}
\textbf{Tech stack:} Python3, Gitlab, Linux, Celery, asyncio, aoihttp, Tornado, Marshmallow, Json Schema, PostgreSQl, SQLAlchemy, Alembic, OpenAPI Specification, Swagger UI
\sectionsep
...
\end{tightemize}
\textbf{Tech stack:} Python3, Linux, Gitlab, Docker Compose, Selenium, Swagger UI, Scrapy, Splash, Pandas, Appache Airflow
\sectionsep
